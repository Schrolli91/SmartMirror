...
# https://de.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&exintro=1&explaintext=1&utf8=1&titles=Albert+Einstein
#
# {
#   "batchcomplete": "",
#   "query": {"pages": {"1278360": {
...
# ↑ Physics World Magazine, 1999 – Vergleiche: BBC-Artikel.
